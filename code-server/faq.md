...
internet](https://coder.com/docs/code-server/guide).

## Can I use code-server on the iPad?

See [iPad](https://coder.com/docs/code-server/ipad) for information on using code-server on the iPad.
...
2. [Remote Extensions (SSH, Containers,\\
...
strongly discourage you from doing so since this is [against their Terms of Use](https://coder.com/docs/code-server/FAQ#why-cant-code-server-use-microsofts-extension-marketplace).
